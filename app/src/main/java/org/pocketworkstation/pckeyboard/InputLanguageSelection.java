...
public class InputLanguageSelection extends PreferenceActivity {
    ...
    private static final String[] KBD_LOCALIZATIONS = {
        ...
        "el", "en", "en_CX", "en_CK", "en_DH", "en_DV", "en_GB", "es", "es_LA", "es_US",
    ...
    private static final String[] KBD_5_ROW = {
        ...
        "en", "en_CX", "en_CK", "en_DH", "en_DV", "en_GB", "es", "es_LA", "fa", "fi", "fr",
    ...
    private static final String[] KBD_4_ROW = {
        "ar", "bg", "bg_ST", "cs", "cs_QY", "da", "de", "de_NE", "el",
        "en", "en_CX", "en_CK", "en_DH", "en_DV", "es", "es_LA", "es_US", "fa", "fr", "fr_CA",
    ...
    private static String getLocaleName(Locale l) {
        ...
        } else if (lang.equals("en") && country.equals("CK")) {
            return "English (Colemak)";
        } else if (lang.equals("en") && country.equals("DH")) {
            return "English (Colemak-DH)";
