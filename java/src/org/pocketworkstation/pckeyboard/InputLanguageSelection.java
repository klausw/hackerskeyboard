...
public class InputLanguageSelection extends PreferenceActivity {
    ...
    private static final String[] KBD_LOCALIZATIONS = {
        "ar", "bg", "ca", "cs", "cs_QY", "da", "de", "de_NE", "el", "en",
        "en_DV", "en_GB", "es", "es_LA", "es_US", "fa", "fi", "fr", "fr_CA",
        "he", "hr", "hu", "hu_QY", "hy", "in", "it", "iw", "ja", "ko",
    ...
    private static final String[] KBD_5_ROW = {
        "ar", "bg", "cs", "cs_QY", "da", "de", "de_NE", "el", "en", "en_DV",
        "en_GB", "es", "es_LA", "fa", "fi", "fr", "fr_CA", "he", "hr", "hu",
        "hu_QY", "hy", "it", "iw", "lo", "nb", "pt_PT", "ro", "ru", "ru_PH",
